...
def delete() :
	...
	# get the task number, which is requilight gray to delete
...
if __name__ == "__main__" :
	...
	Submit = Button(gui, text = "Submit", fg = "Black", bg = "light gray", command = insertTask)
	...
	# when user press the button, the command or
	# function affiliated to that button is executed .
	delete = Button(gui, text = "Delete", fg = "Black", bg = "light gray", command = delete)

	# create a Exit Button and place into the root window
	# when user press the button, the command or
	# function affiliated to that button is executed .
	Exit = Button(gui, text = "Exit", fg = "Black", bg = "light gray", command = exit)
	...
	Submit.grid(row = 2, column = 2,pady = 4)
